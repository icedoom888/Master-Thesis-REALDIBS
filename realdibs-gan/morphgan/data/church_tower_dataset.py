...
class church_tower_dataset(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self):
        return tfds.core.DatasetInfo(
            builder=self,
            description=("This is the church_tower dataset for RealDibs project. "
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            tfds.core.SplitGenerator(
                ...
                gen_kwargs={
                    "render_path": base_path + 'results/render/church_tower/paired/train/',
                    "real_path": base_path + 'data/church_tower/undistorted/train/',
                    "mask_path": base_path + 'results/render/church_tower/masks/train/'
                },
            ),
            tfds.core.SplitGenerator(
                name=tfds.Split.TEST,
                gen_kwargs={
                    "render_path": base_path + 'results/render/church_tower/paired/test/',
                    "real_path": base_path + 'data/church_tower/undistorted/test/',
                    "mask_path": base_path + 'results/render/church_tower/masks/test/'
                },
            ),
            tfds.core.SplitGenerator(
                name='TEST_ONE',
                gen_kwargs={
                    "render_path": base_path + 'results/render/church_tower/paired/test_one/',
                    "real_path": base_path + 'data/church_tower/undistorted/test_one/',
                    "mask_path": base_path + 'results/render/church_tower/masks/test_one/'
                },
            ),
        ]
...
if __name__ == '__main__':
    ...
    church_tower_train = tfds.load(name='church_tower_dataset',
                                   data_dir=base_path + 'datasets', split=tfds.Split.TEST)

    for sample in church_tower_train:
