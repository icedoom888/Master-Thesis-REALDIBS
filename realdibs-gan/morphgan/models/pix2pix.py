...
class Pix2pix:
    ...
    def load_checkpoint(self):
        ...
        print('Loading model from checkpoint: ', self.flags.ckpt_path)
    ...
    def log_test(self, input_image, target, gen_output, epoch):
        ...
        with self.writer.as_default():
            ...
            # DEBUG: write input, generated, target images to TensorBoard
    ...
    def train_step(self, input_image, target, epoch, mask):
        ...
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            # feed real and generated images to discriminator
