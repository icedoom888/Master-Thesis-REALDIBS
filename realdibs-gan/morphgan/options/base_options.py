...
class Base_options:
    ...
    def __init__(self):
        ...
        flags.DEFINE_integer('resize_to', 1800, 'art gan style reszing')
        flags.DEFINE_bool('resize', False, 'if art gan style reszing')
        ...
        flags.DEFINE_string('ckpt_path', None, 'Path to model checkpoints')
