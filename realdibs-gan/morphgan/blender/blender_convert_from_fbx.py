# convert fbx to blender file format (including agisoft transformation)
...
def blender_render_loop_cameras(name,outpath):
    ...
    for ob in bpy.data.objects:
        if ob.type == 'CAMERA':
            ...
            # just original camera ohoto name
            render_filename = camera_name + '.png'
    ...
    if 1:
        render_filename = name+ '.blend' # '_cam_' +  camera_name +
