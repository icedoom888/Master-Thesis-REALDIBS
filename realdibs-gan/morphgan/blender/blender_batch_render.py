...
if 1:
    ...
    if 1:
        ...
        sys.path.append('/home/alberto/anaconda3/envs/new_torch/lib/python3.7/site-packages/')

import rendering_scripts.loggy as loggy
import rendering_scripts.configy as configy
...
def blender_render_loop_cameras(name,outpath):
    ...
    for ob in bpy.data.objects:
        if ob.type == 'CAMERA':
            ...
            # transform
            if 0:
                to_save[camera_name] = numpy.array(ob.matrix_world).tolist()
...
def main():
    ...
    if 0: blender_setup_environment()
    if 0: blender_clean_cameras_lights()
...
if __name__== "__main__":
    ...
    configfile = 'rendering_scripts/resources/trinity.json'
    configfile = 'rendering_scripts/resources/goblin.json'
    configfile = 'rendering_scripts/resources/sullens.json'
